...
export default function Profile() {
    ...
    useEffect(() => {
        async function getUser() {
            try {
                const user = await fetch(`${process.env.NEXT_PUBLIC_SERVER_PORT}/v1/users`, {
                    credentials: "include",
                });
        ...
        async function getWatchedMovie() {
            try {
                const watchedMovie = await fetch(`${process.env.NEXT_PUBLIC_SERVER_PORT}/v1/movies/reviews`, {
                    credentials: "include",
                });
                        ...
                        <div className="body-text mt-3">
                            ...
                            <div className="inline-flex w-full justify-center md:justify-start gap-5">
                                {item.bookings.map((item, idx: number) => (
                                    <p key={idx} className="font-inter font-semibold text-xl text-third">
