...
import { FormProvider, SubmitHandler, useFieldArray, useFormContext, useWatch } from "react-hook-form";
import { FormTypeCreateCinema, useFormCreateCinema } from "./schema/CinemaSchema";
...
export const CreateCinema = () => {
    ...
    const onSubmit: SubmitHandler<FormTypeCreateCinema> = async (formData) => {
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_SERVER_PORT}/v1/cinemas`, {
                method: "POST",
                headers: {
                    ...
                    <div className="body md:mx-10">
                        <form id="cinemaForm" className="flex flex-col" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="cinema flex flex-col mb-4">
                                <label className="font-inter font-medium text-xl text-third pb-2" htmlFor="cinema">
                                    Cinema
                                </label>
                                <input
                            ...
                            <div className="manager-id flex flex-col mb-4">
                                <label className="font-inter font-medium text-xl text-third pb-2" htmlFor="manager">
                                    Manager ID
                                </label>
                                <input
                                    className="input bg-primary border-fourth focus:border-third border-1 rounded-lg"
                            ...
                            <div className="address flex flex-col mb-4">
                                <label className="font-inter font-medium text-xl text-third pb-2" htmlFor="address">
                                    Address
                                </label>
                                <textarea
                                    className="input bg-primary border-fourth focus:border-third border-1 rounded-lg"
                        ...
                        <div className="border-third border-2 p-5 rounded-lg">
                            ...
                            <div className="flex flex-col mt-5 gap-2">
                                <div className="grid grid-cols-2 gap-2">
                                    ...
                                    <div className="flex flex-col">
                                        <label className="font-inter font-medium text-lg text-third" htmlFor="">
                                            Price
                                        </label>
                                        <input
                                ...
                                <div className="grid grid-cols-2 gap-2">
                                    <div className="flex flex-col">
                                        <label className="font-inter font-medium text-lg text-third" htmlFor="column">
                                            Columns
                                        </label>
                                        <input
                                            className="input input-sm bg-primary border-fourth focus:border-third border-1 rounded-lg"
