...
import { FormTypeCreateMovie, Genre, Rated, useFormCreateMovie } from "./schema/MovieSchema";
...
export default function CreateMovieForm() {
    ...
    const onSubmit: SubmitHandler<FormTypeCreateMovie> = async (formData) => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_SERVER_PORT}/v1/movies`, {
                method: "POST",
                body: form,
                credentials: "include",
            });
                    ...
                    <div>
                        <form id="movieForm" className="flex flex-col" onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className="title flex flex-col mb-4">
                                <label className="font-inter font-medium text-xl text-third pb-1" htmlFor="title">
                                    Title
                                </label>
                                <input
                            ...
                            <div className="director flex flex-col mb-4">
                                <label className="font-inter font-medium text-xl text-third pb-1" htmlFor="director">
                                    Director
                                </label>
                                <input
                                    className="input bg-primary border-fourth focus:border-third border-1 rounded-lg"
                            ...
                            <div className="duration flex flex-col mb-4">
                                <label className="font-inter font-medium text-xl text-third pb-1" htmlFor="duration">
                                    Duration in Minutes
                                </label>
                                <input
                                    className="input bg-primary border-fourth focus:border-third border-1 rounded-lg"
                            ...
                            <div className="release-year flex flex-col mb-4">
                                <label className="font-inter font-medium text-xl text-third pb-1" htmlFor="releaseDate">
                                    Release Year
                                </label>
                                <input
                                    className="input bg-primary border-fourth focus:border-third border-1 rounded-lg"
                            ...
                            <div className="genre flex flex-col mb-4">
                                <label className="font-inter font-medium text-xl text-third pb-1" htmlFor="genre">
                                    Genre
                                </label>
                                <select
                            ...
                            <div className="rated flex flex-col mb-4">
                                <label className="font-inter font-medium text-xl text-third pb-1" htmlFor="rated">
                                    Rated
                                </label>
                                <select
                                    className="select bg-primary border-fourth focus:border-third border-1 rounded-lg"
                            ...
                            <div className="synosis flex flex-col mb-4">
                                <label className="font-inter font-medium text-xl text-third pb-1" htmlFor="synopsis">
                                    Synopsis
                                </label>
                                <textarea
                                    className="input bg-primary border-fourth focus:border-third border-1 rounded-lg"
                            ...
                            <div className="poster flex flex-col mb-4">
                                <label className="font-inter font-medium text-xl text-third pb-2" htmlFor="">
                                    Movie Poster
                                </label>
                                <input
                                    type="file"
