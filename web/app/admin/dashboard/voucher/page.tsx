...
import { FormTypeCreateVoucher, useFormCreateVoucher } from "@/components/schema/VoucherSchema";
...
export default function Voucher() {
    ...
    const onSubmit: SubmitHandler<FormTypeCreateVoucher> = async (formData) => {
        ...
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_SERVER_PORT}/v1/vouchers`, {
                method: "POST",
                headers: {
                ...
                <div className="card-body">
                    ...
                    <div className="body md:mx-10">
                        <FormProvider {...methods}>
                            <form id="voucher" className="flex flex-col" onSubmit={handleSubmit(onSubmit)}>
                                {/* Voucher Id */}
