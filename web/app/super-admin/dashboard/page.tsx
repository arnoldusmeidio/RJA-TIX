...
export default function HighAdmin() {
    ...
    useEffect(() => {
        async function getAdmins() {
            try {
                const response = await fetch(`${process.env.NEXT_PUBLIC_SERVER_PORT}/v1/admins/search`, {
                    credentials: "include",
                });
        ...
        async function getManagers() {
            try {
                const response = await fetch(`${process.env.NEXT_PUBLIC_SERVER_PORT}/v1/managers/search`, {
                    credentials: "include",
                });
                const data = await response.json();
