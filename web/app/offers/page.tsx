                    ...
                    <div className="hero-content text-center">
                        <div className="body-text text-center absolute right-0 left-0 m-auto flex flex-col justify-center items-center ms-0 md:right-auto md:text-start md:items-start md:ms-32 md:max-w-2xl">
                            ...
                            <p className=" font-inter font-medium text-xl md:text-2xl text-fourth">
                                See all about <span className="text-third">Discount</span> &{" "}
                                <span className="text-third">Promotions</span> here.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <section className="type-studios bg-primary w-full h-full py-10">
                <div className="head sm:flex content-center mx-7 sm:mx-20 md:mx-10 lg:mx-20 mb-2 pb-3 border-b-4 border-third rounded">
                    <h4 className="font-lato font-medium text-center sm:text-start text-3xl">
                        All <span className="text-third">Discount & Promotions</span>
                    </h4>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 lg:gap-20 pt-5">
                    <div className="card bg-secondary w-10/12 md:w-9/12 min-h-20 shadow-xl mx-auto">
                        <div className="card-body">
                            ...
                            <p className="font-inter font-medium text-fourth">
                                Enjoy any movie for just <span className="text-third">30.000,00</span> every Monday!
                                It&apos;s the perfect way to start your week.
                            </p>
                            <p className="font-inter font-medium text-fourth mt-5">
                                Promo code: <span className="text-third">XB3Y2C</span>
                            </p>
                            <p className="font-inter font-medium text-fourth">
                                Availability: <span className="text-third">50 Voucher</span>
                            </p>
                            <p className="font-inter font-medium text-fourth">
                                Expired: <span className="text-third">30 Sept 2024</span>
                            </p>
                        </div>
                    </div>
                    <div className="card bg-secondary w-10/12 md:w-9/12 min-h-20 shadow-xl mx-auto">
