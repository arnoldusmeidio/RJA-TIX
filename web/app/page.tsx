        ...
        <main>
            ...
            <section className="featured-movies bg-primary w-full h-full py-10">
                <div className="head sm:flex content-center mx-7 sm:mx-20 md:mx-10 lg:mx-20 mb-2 pb-3 border-b-4 border-third rounded">
                    ...
                    <h6 className="text-center sm:text-end sm:ms-auto mt-auto"><Link href="/movies" className=" font-lato text-third font-medium text-base hover:underline underline-offset-2 transition-all ease-in">More Movies</Link></h6>
                </div>
                <div className="movies-section grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mx-5 md:mx-10 lg:mx-20 gap-5 lg:gap-20 pt-5">
                    ...
                    <div key={idx} className="card bg-secondary w-64 lg:w-72 xl:w-64 2xl:w-72 h-full mx-auto shadow-xl">
                        <figure className="relative">
                            ...
                            <div className="absolute inset-0 flex items-center justify-center bg-black opacity-0 hover:opacity-70 transition-opacity duration-300">
                                <p className="text-center font-inter font-bold text-third text-3xl opacity-100">{item.releaseYear}</p>
                            </div>
                        </figure>
                        <div className="card-body">
                            <h2 className="card-title text-justify text-third font-inter font-semibold">{item.title}</h2>
                            <div className="duration-price inline-flex text-sm mt-auto">
                                <p className="price">{item.director}</p>
                                <p className="text-fourth text-end font-inter font-semibold mb-3"><span className="text-third me-2">|</span> {item.rated}</p>
                            </div>
                ...
                <div className="grid grid-cols-3 grid-rows-2 gap-8 mx-7 sm:mx-10 md:mx-20">
                    <div className="col-span-3 row-span-2 sm:col-span-1  sm:row-span-2 flex justify-center items-center">
                        <Image
                            ...
                            loading="lazy"
                        />
                        <Link href="#" className="absolute text-3xl font-semibold font-inter text-fourth text-center max-w-64">Join now and enjoy exclusive perks!</Link>
                    </div>
                    <div className="col-span-3 row-span-2 md:col-span-2 md:row-span-1 flex justify-center items-center">
                        <Image
                            ...
                            loading="lazy"
                        />
                        <Link href="#" className="absolute text-3xl font-semibold font-inter text-fourth text-center max-w-64">Our Cinemas</Link>
                    </div>
                    <div className="col-span-3 row-span-2 md:col-span-2 md:row-span-1 flex justify-center items-center">
                        <Image
                            src="/Others-3.png"
                            ...
                            loading="lazy"
                        />
                        <Link href="#" className="absolute text-3xl font-semibold font-inter text-fourth text-center max-w-64">Our Offers</Link>
                    </div>
                </div>
            </section>
            {/* Others */}
