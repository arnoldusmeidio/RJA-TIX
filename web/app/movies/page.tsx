...
export default function Movies({ searchParams }: { searchParams: { [key: string]: string | string[] | undefined } }) {
    ...
    return (
        <main>
            ...
            {/* Movie this Week */}
            <section className="featured-movies bg-primary w-full h-full py-10" id="movie-section">
                            ...
                            <div className="card-body">
                                ...
                                <div className="duration-price inline-flex text-sm mt-auto">
                                    ...
                                    <p className="text-fourth text-end font-inter font-semibold mb-3">
                                        <span className="text-third me-2">|</span> {item.rated.replace("_", " ")}
                                    </p>
                                </div>
