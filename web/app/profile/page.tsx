                    ...
                    <table className="table">
                        ...
                        <tbody>
                            ...
                            <tr className="hover:bg-secondary text-center">
                                ...
                                <td>Interstellar</td>
                                <td>
                                    <label htmlFor="review-tab-1" role="button" tabIndex={0} className="btn bg-third text-primary font-semibold hover:bg-primary hover:text-third transition-all ease-in-out">Review</label>
                                    <input type="checkbox" id="review-tab-1" className="modal-toggle" />
                                    <div className="modal bg-secondary" role="dialog">
                                        <div className="modal-box h-3/3">
                                            <h3 className="text-center md:text-start text-2xl font-semibold text-third">Interstellar</h3>
                                            <div className="py-4">
                                                <p className="text-center md:text-start text-lg font-medium text-fourth font-lato mb-2">Rate Film</p>
                                                <input type="range" min={0} max="100" step={25} className="range range-warning range-xs" />
                                            ...
                                            <div className="form-control ">
                                                ...
                                                <textarea rows={3} className="textarea textarea-bordered" placeholder="Your message"></textarea>
                                            </div>
                                            <div className="modal-action pt-auto">
                                                <label className="btn bg-third text-primary hover:bg-primary hover:text-third">Submit</label>
                                                <label htmlFor="review-tab-1" className="btn bg-primary text-third hover:bg-third hover:text-primary">Close</label>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr className="hover:bg-secondary text-center">
                                ...
                                <td>Twister</td>
                                <td>
                                    <label htmlFor="review-tab-2" role="button" tabIndex={0} className="btn bg-third text-primary font-semibold hover:bg-primary hover:text-third transition-all ease-in-out">Review</label>
                                    <input type="checkbox" id="review-tab-2" className="modal-toggle" />
                                    <div className="modal bg-secondary" role="dialog">
                                        <div className="modal-box h-3/3">
                                            <h3 className="text-center md:text-start text-2xl font-semibold text-third">Twister</h3>
                                            <div className="py-4">
                                                <p className="text-center md:text-start text-lg font-medium text-fourth font-lato mb-2">Rate Film</p>
                                                <input type="range" min={0} max="100" step={25} className="range range-warning range-xs" />
                                                <div className="flex w-full justify-between px-2 text-xs">
                                            ...
                                            <div className="modal-action pt-auto">
                                                <label className="btn bg-third text-primary hover:bg-primary hover:text-third">Submit</label>
                                                <label htmlFor="review-tab-2" className="btn bg-primary text-third hover:bg-third hover:text-primary">Close</label>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr className="hover:bg-secondary text-center">
                                ...
                                <td>Inside Out 2</td>
                                <td>
                                    <label htmlFor="review-tab-3" role="button" tabIndex={0} className="btn bg-third text-primary font-semibold hover:bg-primary hover:text-third transition-all ease-in-out">Review</label>
                                    <input type="checkbox" id="review-tab-3" className="modal-toggle" />
                                    <div className="modal bg-secondary" role="dialog">
                                        <div className="modal-box h-3/3">
                                            <h3 className="text-center md:text-start text-2xl font-semibold text-third">Inside Out 2</h3>
                                            <div className="py-4">
                                                <p className="text-center md:text-start text-lg font-medium text-fourth font-lato mb-2">Rate Film</p>
                                                <input type="range" min={0} max="100" step={25} className="range range-warning range-xs" />
                                                <div className="flex w-full justify-between px-2 text-xs">
                                            ...
                                            <div className="modal-action pt-auto">
                                                <label className="btn bg-third text-primary hover:bg-primary hover:text-third">Submit</label>
                                                <label htmlFor="review-tab-3" className="btn bg-primary text-third hover:bg-third hover:text-primary">Close</label>
                                            </div>
                                        </div>
                                    </div>
                                </td>
            ...
            <section className="ticket bg-primary w-full h-full mb-20">
                ...
                <div className="booked-film flex flex-col md:flex-row content-center mx-7 sm:mx-20 md:mx-10 lg:mx-20 pt-7 gap-5 md:gap-20">
                    ...
                    <div className="body-text mt-3">
                        <h5 className="font-inter font-semibold text-center md:text-start text-4xl text-third mb-2">Interstellar</h5>
                        <p className="cinema font-inter font-medium text-center md:text-start text-xl text-fourth mb-1">Starium<span className="mx-3"> | </span>Plaza Indonesia</p>
                        <p className="clock font-inter font-semibold text-center md:text-start text-2xl text-third mb-5">06:00 PM</p>
                        <h6 className="seat font-inter font-medium text-center md:text-start text-xl text-fourth mb-1">Your Seat:</h6>
                        <div className="inline-flex w-full justify-center md:justify-start gap-5">
                            ...
                            <p className="font-inter font-semibold text-xl text-third">4.10</p>
                        </div>
                    </div>
                </div>
            </section>
