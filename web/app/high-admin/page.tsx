                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                    ...
                    <div className="bg-secondary p-7 rounded-2xl">
                        ...
                        <div className="button-add-delete flex">
                            <button className="btn btn-sm bg-third text-primary hover:bg-primary hover:text-third font-inter font-semibold">Add Admin</button>
                    ...
                    <div className="bg-secondary p-7 rounded-2xl">
                        ...
                        <div className="button-add-delete flex">
                            <button className="btn btn-sm bg-third text-primary hover:bg-primary hover:text-third font-inter font-semibold">Add Cinema</button>
                            <button className="btn btn-sm ms-auto bg-primary text-third hover:bg-third hover:text-primary font-inter font-semibold">Delete Cinema</button>
                        </div>
