    ...
    return (
        <nav className="navbar bg-secondary">
                ...
                <div className="drawer lg:hidden z-20">
                    ...
                    <div className="drawer-side">
                        ...
                        <ul className="menu bg-base-200 text-base-content min-h-full w-80">
                            <label htmlFor="my-drawer" className="text-2xl drawer-button px-4 pt-3 pb-3">
                                <IoClose />
                            </label>
                            ...
                            {user?.admin !== null ? null : user?.manager !== null ? null : <AccountBalanceSidebar />}
                            ...
                            <div className="dropdown dropdown-top dropdown-hover sm:hidden profile mt-auto mb-3 p-3 px-4 bg-secondary rounded-2xl shadow-lg transition-all ease-in">
                                ...
                                >
                                    {!user ? (
                                        <Link className="p-1 text-sm ps-4 hover:bg-gray-700 rounded-lg" href="/login">
                                            Login / Register
                                        </Link>
                                    ) : (
                                        <>
            ...
            <div className="navbar-end">
                ...
                {/* Account balance */}
                {user?.admin !== null ? null : user?.manager !== null ? null : <AccountBalanceIcon />}
                {/* Account balance */}
