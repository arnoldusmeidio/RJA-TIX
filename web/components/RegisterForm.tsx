...
export default function RegisterForm() {
    ...
    const onSubmit: SubmitHandler<FormTypeRegister> = async (formData) => {
        try {
            const response = await fetch(`${process.env.NEXT_PUBLIC_SERVER_PORT}/v1/auth/register`, {
                method: "POST",
                headers: {
    ...
    return (
        <>
            <form id="registerForm" onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-2">
